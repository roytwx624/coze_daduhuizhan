    ...
    <section class="top-background-section">
      ...
      <div class="search-container">
        <div class="search-content">
          <h1>大都会展数智平台</h1>
          <p class="search-guide">一站式查询展会、场馆、政策、招投标信息及展会服务，精准信息一键直达</p>
...
import banner1 from '@/assets/images/exhibition/20260122-111812.430-1.jpg'
import banner2 from '@/assets/images/exhibition/20260122-111812.430-2.jpg'
import banner3 from '@/assets/images/exhibition/20260122-111812.430-3.jpg'
import banner4 from '@/assets/images/exhibition/插画展.png'
...
// Banner高度自适应
const bannerHeight = ref('560px')

const updateBannerHeight = () => {
  const width = window.innerWidth
  // 保持 1920:560 的比例 (进一步增加高度)
  const height = Math.floor(width * (560 / 1920))
  // 设置最大高度为 560px (当宽度 > 1920 时)
  bannerHeight.value = (width > 1920 ? 560 : height) + 'px'
}
